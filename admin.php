            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Committee Registration</h1>
                    </div>
                    ...
                    <div class="container pt-2 my-5 border animate__animated animate__backInRight">
                        <form action="addadmin.php" method="post" class="needs-validation" novalidate>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        $query = "SELECT * FROM role WHERE RID IN (4)";
                                        $result = mysqli_query($conn, $query);
                                        ?>
