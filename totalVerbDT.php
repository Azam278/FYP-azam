<?php
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        $dtLevels[] = $row['DT_Level'];
        $totalVerbs[] = $row['TotalVerbs'];
    }
    ...
    if (count($dtLevels) > 0) {
        ...
        $chartData = array(
            ...
            'datasets' => array(
                array(
                    'label' => 'Total Verbs For Every Domain Taxonomy Levels',
                    'data' => $totalVerbs,
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4 hide-on-print">
                        <h1 class="h3 mb-0 text-gray-800 hide-on-print">Report Total Verb</h1>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="pdfcontainer">
                            ...
                            <h2>Total Verb for Each Domain Taxonomy</h2>
                            <div class="container">
                                <?php
                                    if (count($dtLevels) > 0) {
