            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Pending List</h1>
                    </div>
                    ...
                    <?php
                        if (isset($_SESSION['userid'])){
                            ...
                            // Query to get the courses assigned to the user
                            $courseQuery = "SELECT CourseID, CourseName FROM course WHERE EV1 = '$userid' OR EV2 = '$userid'";
                    ...
                    <?php
                        if (isset($_SESSION['userid'])) {
                            ...
                            WHERE ((c.EV1 = '$userid' AND qpl.QPLStatus = 'pending') OR (c.EV2 = '$userid' AND qpl.QPLStatus2 = 'pending')) AND c.CourseID = '$selectedCourse'";                           
                            ...
                            if ($result) {
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    echo '<input class="btn-notapprove" type="submit" name="not_approve" value="Not Approved">';
                                    echo '<input class="btn-approve" type="submit" name="approve" value="Approve">';
                                    echo '<br>';
                                    echo '<table id="pendingTable" class="table table-hover table-striped table-bordered">';
                                    echo "<tr><th><input type='checkbox' id='select_all'></th><th>Question</th><th>Taxonomy Level</th><th>Verb</th><th>Mark</th><th>Type</th><th>Status</th></tr>";
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo "<tr>";
                                        echo "<td><input type='checkbox' class='select' name='selected[]' value='$pending'></td>";
                                        echo "<td>$question</td>";
                                        echo "<td>$tlevel</td>";
                                        echo "<td>$vname</td>";
                                        echo "<td>$mark</td>";
