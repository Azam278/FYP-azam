                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="btverbForm">
                            <div class="container">
                                <h3>Add Domain Taxonomy</h3>
                                <form action="addbtaxonomy.php" method="post">

                                    <div class="form-group">
                                        <label for="domain">Taxonomy Level:</label>
                                        <input type="text" class="form-control" id="domain" name="lvtaxonomy" placeholder="Enter Taxonomy Level">
                                    </div>

                                    <div class="form-group">
                                        <label for="desctaxonomy">Description:</label>
                                        <input class="form-control" type="text" placeholder="Enter Description" name="desctaxonomy" required>
                                    </div>
