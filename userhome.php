<?php
    ...
    if (isset($_SESSION['userid'])) {
        ...
        $query = "SELECT COUNT(*) AS total_questions FROM question_paper_list WHERE Staff_ID = '$userid' AND QPLStatus = 'Approved'";

        $resulQuestion = mysqli_query($conn, $query);
        $rowQuestion = mysqli_fetch_assoc($resulQuestion);
        $totalQuestion = $rowQuestion['total_questions'];

        $query = "SELECT COUNT(*) AS total_assessment FROM assessment WHERE Staff_ID = '$userid'";

        $resulAssessment = mysqli_query($conn, $query);
        $rowAssessment = mysqli_fetch_assoc($resulAssessment);
        $totalAssessment = $rowAssessment['total_assessment'];
    }
?>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total Questions Made</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $totalQuestion; ?></div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $totalAssessment; ?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-calendar fa-2x text-gray-300"></i>
                                        </div>
